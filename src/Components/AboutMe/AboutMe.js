        ...
        <div className="about-me-container">
          ...
          <div className="about-me-text-container">
            <p className="about-me-text">
              ...
              medical field. I spend three years working towards my Dental
              Hygiene degree, but soon realized what I loved most about the
              field was the knowledge aspect of going through school. I then
              decided to pivot towards an industry that truly encompasses
              continuous learning.
              <br />
